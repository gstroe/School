...
typedef RT_MODEL_LAB07_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * LAB07(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void LAB07_initialize();
   extern void LAB07_terminate();
 */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(LAB07_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://LAB07:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: LAB07 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,

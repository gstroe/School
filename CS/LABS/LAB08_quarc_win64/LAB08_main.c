...
#define rtmGetNumSampleTimes(rtm)      (1)
#endif
...
typedef RT_MODEL_LAB08_T RT_MODEL;

/*====================*
 * External functions *
 *====================*/
EXTERN RT_MODEL * LAB08(void);

/* A global buffer for storing error messages (defined in quanser_common library) */
EXTERN char _rt_error_message[512];

/*
   extern void LAB08_initialize();
   extern void LAB08_terminate();
 */

/* extern void LAB08_step(void); */
  ...
  _do_assertion(const char * expression, const char * file_name, int line_number)
{
  ...
  rtmSetErrorStatus(LAB08_M, GBLbuf.message);
}
  ...
  main(int argc, char * argv[])
{
  ...
  rtExtModeQuarcParseArgs(argc, (const char **) argv, "shmem://LAB08:1");
  ...
  if (parseError) {
    (void) fprintf(stderr,
                   "\nUsage: LAB08 -option1 val1 -option2 val2 -option3 ...\n\n");
    (void) fprintf(stderr,

...
void q_qube_swingup_output(void)
{
  real_T A;
  real_T B;
...
void q_qube_swingup_update(void)
{
  if (rtmIsMajorTimeStep(q_qube_swingup_M)) {
...

  {
    ...
    q_qube_swingup_M->Timing.t[1] = q_qube_swingup_M->Timing.clockTick1 *
      q_qube_swingup_M->Timing.stepSize1 + q_qube_swingup_M->Timing.clockTickH1 *
      q_qube_swingup_M->Timing.stepSize1 * 4294967296.0;
  }
}
...
{
  q_qube_swingup_output();
  UNUSED_PARAMETER(tid);
}

void MdlUpdate(int_T tid)
{
  q_qube_swingup_update();
  UNUSED_PARAMETER(tid);
}
...
void MdlStart(void)
{
  q_qube_swingup_initialize();
}

void MdlTerminate(void)
{
  q_qube_swingup_terminate();
}

/* Registration function */
RT_MODEL_q_qube_swingup_T *q_qube_swingup(void)
{
  /* Registration code */
  ...
  q_qube_swingup_M->ModelData.contStates = ((real_T *) &q_qube_swingup_X);
  ...
  {
    int_T *mdlTsMap = q_qube_swingup_M->Timing.sampleTimeTaskIDArray;
    mdlTsMap[0] = 0;
    mdlTsMap[1] = 1;
    q_qube_swingup_M->Timing.sampleTimeTaskIDPtr = (&mdlTsMap[0]);
    q_qube_swingup_M->Timing.sampleTimes =
      (&q_qube_swingup_M->Timing.sampleTimesArray[0]);
    q_qube_swingup_M->Timing.offsetTimes =
      (&q_qube_swingup_M->Timing.offsetTimesArray[0]);

    /* task periods */
    q_qube_swingup_M->Timing.sampleTimes[0] = (0.0);
    q_qube_swingup_M->Timing.sampleTimes[1] = (0.002);

    /* task offsets */
    q_qube_swingup_M->Timing.offsetTimes[0] = (0.0);
    q_qube_swingup_M->Timing.offsetTimes[1] = (0.0);
  }

  rtmSetTPtr(q_qube_swingup_M, &q_qube_swingup_M->Timing.tArray[0]);

  {
    int_T *mdlSampleHits = q_qube_swingup_M->Timing.sampleHitArray;
    mdlSampleHits[0] = 1;
    mdlSampleHits[1] = 1;
    q_qube_swingup_M->Timing.sampleHits = (&mdlSampleHits[0]);
  }

  rtmSetTFinal(q_qube_swingup_M, -1);
  q_qube_swingup_M->Timing.stepSize0 = 0.002;
  q_qube_swingup_M->Timing.stepSize1 = 0.002;

  /* External mode info */
  q_qube_swingup_M->Sizes.checksums[0] = (1644598056U);
  q_qube_swingup_M->Sizes.checksums[1] = (279141539U);
  q_qube_swingup_M->Sizes.checksums[2] = (974166807U);
  q_qube_swingup_M->Sizes.checksums[3] = (1700312598U);
  ...
  q_qube_swingup_M->solverInfoPtr = (&q_qube_swingup_M->solverInfo);
  q_qube_swingup_M->Timing.stepSize = (0.002);
  rtsiSetFixedStepSize(&q_qube_swingup_M->solverInfo, 0.002);
  rtsiSetSolverMode(&q_qube_swingup_M->solverInfo, SOLVER_MODE_SINGLETASKING);

  /* block I/O */
  q_qube_swingup_M->ModelData.blockIO = ((void *) &q_qube_swingup_B);
  ...
  /* parameters */
  q_qube_swingup_M->ModelData.defaultParam = ((real_T *)&q_qube_swingup_P);

  /* states (continuous) */
  {
    real_T *x = (real_T *) &q_qube_swingup_X;
    q_qube_swingup_M->ModelData.contStates = (x);
    (void) memset((void *)&q_qube_swingup_X, 0,
                  sizeof(X_q_qube_swingup_T));
  }

  /* states (dwork) */
  q_qube_swingup_M->ModelData.dwork = ((void *) &q_qube_swingup_DW);
  ...
  /* Initialize Sizes */
  q_qube_swingup_M->Sizes.numContStates = (3);/* Number of continuous states */
  q_qube_swingup_M->Sizes.numY = (0);  /* Number of model outputs */
  q_qube_swingup_M->Sizes.numU = (0);  /* Number of model inputs */
  q_qube_swingup_M->Sizes.sysDirFeedThru = (0);/* The model is not direct feedthrough */
  q_qube_swingup_M->Sizes.numSampTimes = (2);/* Number of sample times */
  q_qube_swingup_M->Sizes.numBlocks = (54);/* Number of blocks */
  q_qube_swingup_M->Sizes.numBlockIO = (40);/* Number of block outputs */
  q_qube_swingup_M->Sizes.numBlockPrms = (96);/* Sum of parameter "widths" */
  return q_qube_swingup_M;
}

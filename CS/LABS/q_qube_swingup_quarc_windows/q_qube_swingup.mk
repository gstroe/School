...
MODEL                = q_qube_swingup
MODULES              = q_qube_swingup_data.c q_qube_swingup_main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE             = q_qube_swingup.mk
...
S_FUNCTIONS_LIB      = C:\PROGRA~1\Quanser\QUARC\lib\windows\hil.lib C:\PROGRA~1\Quanser\QUARC\lib\windows\QUDCFC~1.LIB C:\PROGRA~1\Quanser\QUARC\lib\windows\QUANSE~3.LIB
SOLVER               = 
NUMST                = 2
TID01EQ              = 1
NCSTATES             = 3
...
MODELLIB                  = q_qube_swinguplib.lib
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = q_qube_swingup_ref.rsp
MODELREF_INC_PATH         = 
...
START_DIR         = C:\Users\gstroe\Documents\School\CS\LABS
MASTER_ANCHOR_DIR = 
...
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)\q_qube_swingup_quarc_windows
MATLAB_INCLUDES = $(MATLAB_INCLUDES);$(START_DIR)
MATLAB_INCLUDES = $(MATLAB_INCLUDES);C:\Users\gstroe\Downloads
...
# Remove the -Wp64 flag since it is deprecated and is not needed for 32-bit code
cflags = $(cflags:-Wp64=)

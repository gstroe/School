...
*                                                                           
* PURPOSE: Include in all C source files to provide global variable
*          sharing.
*                                                                           
*                                                                           
*                                                                           
...
/*************************************************************************
* Global variable declarations external scope                            *
*								  																											 *
**************************************************************************/



extern unsigned char rti_blink_off_cnt; 
extern unsigned char rti_blink_on_cnt;

extern unsigned char ucCST;      // RTI control state
extern unsigned char ucTEMP1;    // uc TEMP 1
extern unsigned char ucFLAG1;    // uc FLAG 1
extern unsigned char ucFLAG2;    // uc FLAG 2
extern unsigned char ucSPI_LSB;
extern unsigned char ucSPI_MSB;

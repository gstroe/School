...
/*****************************************************************************/
/*                                                                           */
/* FILE NAME: S12FTS128KV2.h                                          	     */
/*                                                                           */
/* PURPOSE: Header File for S12 FLASH (128K)   					 		                 */
/*                                                                           */
...
#ifndef S12FTS128KV2_H			/*prevent duplicated includes */
#define S12FTS128KV2_H
...
typedef union uFCNFG
  ...
  struct
    {
    tU08 bksel	:1;		/*register bank select */
    tU08		:4;		/*not used */
...
#define FPHDIS		0x20	
/* no NV6 0x40 definition, it exists in FSEC register */
#define FPOPEN		0x80

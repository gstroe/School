...
#ifndef S12DT128PIMV2_H			/*prevent duplicated includes */
#define S12DT128PIMV2_H
...
typedef struct					/*port integration module  */
  ...
  volatile tPIFJ	pifj;		/*interrupt flag register */
  		   tU08		rsvt2[16];	/*reserved (maintaining memory map) */
  } tPIM;


#endif /*S12DT128PIMV2_H */

...
** Revision History:
**
** Revision: 2.2   02-Nov-2012    Gabriel Moreno, Leonardo Bueno
** * Revised prototype of Dio_WriteChannelGroup and Dio_ReadChannelGroup.
**   Implementation corrected in Dio.c.
**
...
**    offset: Type: uint8/16/32  - This element shall be the position of the Channel Group on the port, counted from the LSB.
...
** Syntax: Dio_PortLevelType Dio_ReadChannelGroup( Dio_ChannelGroups ChannelGroupId )
** Service ID[hex]: 0x04
...
*/
extern Dio_PortLevelType Dio_ReadChannelGroup( Dio_ChannelGroups ChannelGroupId );
...
*/
extern void Dio_WriteChannelGroup( Dio_ChannelGroups ChannelGroupId, Dio_PortLevelType Level );
...
** Syntax: void Dio_InitGPIO( Dio_PortType PortId, uint8_t DDR_CFG_INIT )
** Service ID[hex]: N/A
** Parameters:    PortId               - ID of DIO Port
**                DDR_CFG_INIT         - Data Direction Register Initial Configuration
* Return Value:  None
**
** Description: Initializes GPIO ports
**
